const PRODUCTS = [
  ...
  { id: 4, name: 'Slash Pre-workout', price: 15, brand: 'IDN', stock: 25, category: 'pre-workouts', description: 'Improves your strength, resistance and your general performance for a training session.' },
  { id: 5, name: 'Whey Protein', price: 8, brand: 'HardCore', stock: 30, category: 'proteins', description: 'Concentrate whey protein that helps you cover your diary protein needs.' }
]
